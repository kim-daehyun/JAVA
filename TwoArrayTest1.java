...
public class TwoArrayTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(twoA); //행의 배열 참조값
		System.out.println(twoA[0]);//첫번째 행이 참조하는 열의 배열 참조값
		System.out.println(twoA[0][0]);//1행 1열의 값
		System.out.println(twoA.length);//1행 1열의 값
		System.out.println(twoA[2].length);//1행 1열의 값
